...
- 已透過 Figma MCP 讀取 `2374:25616`、`2374:25617`、`2374:25667`；依節點規格調整 24px 標題、14px 副標題（`#606266`）、上下日期欄位、搜尋／清除按鈕與結果區的文字及色彩。
- 重新核對結果：日期欄位修正為 Figma 的 40dp 高度，搜尋卡內容間距修正為 24dp，日期文字修正為 14sp。
