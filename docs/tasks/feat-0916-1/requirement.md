...
- 清單來源：按主地圖按鈕後清單收起，工作圖層與全部 scope 側溝線段隱藏；退出後回到相同清單，scope 線段依目前 `showPlan` 偏好恢復。
...
- AC-003：清單來源量測時收起清單、隱藏工作圖層與全部 scope 線段；退出或 Back 後回到相同清單，scope 線段依最新 `showPlan` 偏好恢復。
