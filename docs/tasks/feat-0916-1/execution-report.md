...
- After adding focused coverage, `JAVA_HOME='/Applications/Android Studio.app/Contents/jbr/Contents/Home' ./gradlew :app:connectedDebugAndroidTest`: PASS — Android Emulator `Medium_Phone` (`emulator-5554`); 36 tests, 0 failures, 0 errors, 0 skipped. The focused tests cover the list measurement callback wiring and editor measurement-entry layout contract.
